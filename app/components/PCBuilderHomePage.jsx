            ...
            <s-table-row key={widget.id}>
              <s-table-cell>
                {widget.isNew ? (
                  ...
                  <s-text fontWeight="bold" onClick={() => navigate(`/app/edit-widget/${widget.id}`)}>{widget.name}</s-text>
                )}
              </s-table-cell>

              <s-table-cell>
                <s-tooltip id="bold-tooltip">Click to Copy Id</s-tooltip>
                <s-text tone="subdued" interestFor="bold-tooltip" onClick={() => !widget.isNew && copyToClipboard(widget.id)}>
